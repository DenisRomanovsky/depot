...
Product.create!(title: "PlayStation 3", description: "Play Station 3, new and with 5 games in the box! WERTYUIOP{}SDFGHJKL:ZXCVBNM<>?", image_url: "ruby.jpg", price: 43.15)
Product.create!(title: "PlayStation 4",
 description: %{<p>Play Station 4, new and with 10 games in the box! WERTYUIOP{}SDFGHJKL:ZXCVBNM<>? </p>},
  image_url: "rtp.jpg",
  price: 43.15)
Product.create!(title: "Apple iPhone6",
